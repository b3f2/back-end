...
public class CommentServiceTest extends ServiceTestSupport {
    ...
    void readAllTest() throws IOException{
        ...
        //when
        CommentReadRequest commentReadRequest = new CommentReadRequest(1L);
    ...
    void updateCommentTest() throws IOException {
        ...
        //when
        CommentUpdateRequest request1 = new CommentUpdateRequest("update content");
    ...
    void createExceptionByCommentNotFoundTest() throws IOException{
        ...
        postService.create(loginResponse, req, List.of());
        Post post = postRepository.findAll().get(0);
        Optional<Comment> comment = commentRepository.findById(anyLong());

        //when, then
        assertThatThrownBy(()->commentService.create(loginResponse, createCommentCreateRequestWithParentId(1L)))
